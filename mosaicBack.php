...
function resizeImage( $pathToImage, $pathToThumb, $thumbWidth )
{ 
...
?>
<form action="mosaic.php" enctype="multipart/form-data" method="post">
<div>Type in tags for background images:
    <input type="text" id="tags" name="tags" size="30">
</div>

<select id='mediaSelect' name='mediaSelect'>
    <option id='imageOption' value='image' selected="selected">Image</option>
    <option id='videoOption' value='video'>Video</option>
</select>

<div id='imageForm'>
    Please specify an image for the mosaic:<br>
    <input type="file" name="uploadedfile" size="40">
    <input type="hidden" name="submit">
</div>

<div id='videoForm'>
    <label>YouTube Url</label><input type="text" size="50" />
</div>
